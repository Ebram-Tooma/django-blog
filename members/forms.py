...
class SignUpForm(UserCreationForm):
    #adding fields to rigester form and adding its bootstrap widget class to it
    email = forms.EmailField(widget=forms.EmailInput(attrs={'class': 'form-control', 'placeholder': 'Email Addres'}))
    ...
    #adding form- control bootstrap to Default UserCreationForm Attributes
...
class EditProfileForm(UserChangeForm):
    #adding fields to edit form and adding its bootstrap widget class to it
    email = forms.EmailField(widget=forms.EmailInput(attrs={'class': 'form-control', 'placeholder': 'Email Addres'}))
    first_name = forms.CharField(max_length=100, widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'First Name'}))
    last_name = forms.CharField(max_length=100, widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Last Name'}))
...
class PasswordChangingForm(PasswordChangeForm):
    #adding fields to password change form and adding its bootstrap widget class to it
